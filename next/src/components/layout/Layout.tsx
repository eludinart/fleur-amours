  ...
  return (
    <div className="flex h-full min-h-0 flex-1 overflow-hidden bg-slate-50 dark:bg-slate-950">
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <header
          ref={headerRef}
          className="flex items-center gap-2 sm:gap-3 px-2 sm:px-4 pb-2 sm:pb-3 pt-[max(0.5rem,env(safe-area-inset-top,0px))] border-b border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shrink-0 min-w-0 overflow-hidden relative z-10"
        >
          <button
