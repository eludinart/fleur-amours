...
export const campaignsApi = {
  ...
  create: (payload: Record<string, unknown>) => api.post('/api/campaigns', payload),
  results: (id: string) => api.get(`/api/campaigns/${id}/results`),
  submitAnswers: (payload: Record<string, unknown>) => api.post('/api/campaigns/answer', payload),
  definitions: () => api.get('/api/campaigns/definitions'),
  createDef: (payload: Record<string, unknown>) => api.post('/api/campaigns/definitions', payload),
}
